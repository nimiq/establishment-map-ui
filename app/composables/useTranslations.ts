...
export function translateCategory(category?: CategoryType) {
  switch (category) {
...
export function translateIssue(issue: string) {
  switch (issue) {
...
export function translateCurrency(currency: CurrencyType) {
  switch (currency) {
