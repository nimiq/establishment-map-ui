...
const items = [
  {
    ...
    content: t('Our data is gathered from various sources and processed to align with locations using the Google Maps Place API. Although we strive for accuracy, automated collection can sometimes result in errors.'),
  },
  {
    title: t('How to add a business'),
    content: t('To add a business that accepts cryptocurrency to our map, click the "Gear" icon next to the search bar, then "Add business." We will review submissions to ensure compliance with our standards.'),
  },
  {
    title: t('How to report errors'),
    content: t('If you find any errors like e.g. a business that no longer accepts cryptocurrency or has changed locations, open the business information, select the options menu, and click "Report.'),
  },
  {
    title: t('A business on the map does not accept crypto'),
    content: t('If a business no longer accepts crypto, open the business information, go to the options menu, and click on "Report." This helps us keep our information accurate.'),
  },
