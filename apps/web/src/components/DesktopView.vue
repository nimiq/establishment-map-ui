...
<template>
  ...
  <div
    ...
    absolute inset-0 max-w-368 transition="[transform,opacity]" will-change-transform pointer-events-none bg-gradient-to-r from-darkblue to-transparent
  />
  <aside absolute max-w-384 inset-24 right-initial h-max pointer-events-none children:pointer-events-auto flex="~ col">
    ...
    <button pill-tertiary pill-sm ring="1 neutral/10" @click="isListShown = !isListShown" z-10 flex="~ gap-8">
