...
<template>
  <div class="flex items-center gap-x-2">
    ...
    <div>
      <h3 class="text-16 text-space">
        cryptocity.name
      </h3>
      <span class="w-40 text-14 text-space/60 animate-pulse bg-space/20 rounded-xs">{{ $tc('{count} locations', -1) }}</span>
    </div>
